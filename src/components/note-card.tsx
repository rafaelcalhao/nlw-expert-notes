...
export const NoteCard = ({ note, onNoteDeleted }: NoteCardProps) => {
  return (
    <Dialog.Root>
      <Dialog.Trigger className="text-left rounded-md flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 outline-none focus-visible:ring-lime-400">
